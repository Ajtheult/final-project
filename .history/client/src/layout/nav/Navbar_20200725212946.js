    ...
    return (
      <div>
        ...
        <ul id="slide-out" className="sidenav">
          ...
          <li>
            <Link className="waves-effect waves-black" to="/">
              Home
            </Link>
            <Link className="waves-effect waves-black" to="/about">
              About Us
            </Link>
          </li>
          <li>
          ...
          <li>
            ...
            <Link className="waves-effect waves-black" to="/login">
              Login
            </Link>
            <Link className="waves-effect waves-black" to="/register">
              Register user
            </Link>
          </li>
          ...
          <li>
            ...
            <Link className="waves-effect waves-black" to="/catalogue">
              Catalogue
            </Link>

            <Link className="waves-effect waves-black" to="/cart">
              Cart
            </Link>
          </li>
          <li>
          ...
          <li>
            <a
              className="waves-effect waves-black"
