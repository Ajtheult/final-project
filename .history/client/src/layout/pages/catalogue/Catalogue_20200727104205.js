...
const Catalogue = () => {
  const [products] = useState([
    ...
    },
    {
      ...
      description: "a large musical instrument having rows of pipes supplied with air from bellows (now usually electrically powered), and played using a keyboard or by an automatic mechanism The pipes are generally arranged in ranks of a particular type, each controlled by a stop, and often into larger sets linked to separate keyboards.",
      model: "1960 Hammond A100 Organ",
      price: "$35000"
    },
    {
      name: "French manual Harpsichord",
      img={harpsichord_image},
      type: "Keys",
      what: "What is a harpsichord?",
      description: "A harpsichord is a musical instrument played by means of a keyboard. Like a pipe organ, a harpsichord may have more than one keyboard manual and harpsichords may have stop buttons which add or remove additional octaves. Some harpsichords may have a lute stop, which simulates the sound of a plucked lute.",
    ...
    },
    {
      ...
      description: "a stringed musical instrument of treble pitch, played with a horsehair bow. The classical European violin was developed in the 16th century. It has four strings and a body of characteristic rounded shape,narrowed at the middle and with two f-shaped soundholes.",
...

    {
      ...
      description: " The cello or violoncello is a bowed string instrument of the violin family. Its four strings are usually tuned in perfect fifths: from low to high, C₂, G₂, D₃ and A₃, an octave lower than the viola.",
...

    {
      ...
      description: "The clarinet is a family of woodwind instruments. It has a single-reed mouthpiece, a straight, cylindrical tube with an almost cylindrical bore, and a flared bell. A person who plays a clarinet is called a clarinetist.",
      model: "",
      price: "",
    },
    {
