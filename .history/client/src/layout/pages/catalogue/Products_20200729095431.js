...
export default function Products({ addToCart }) {
  const [products] = useState([
    ...
    },
    {
      ...
      description:
        "An organ is a large musical instrument having rows of pipes supplied with air from bellows (now usually electrically powered), and played using a keyboard or by an automatic mechanism The pipes are generally arranged in ranks of a particular type, each controlled by a stop, and often into larger sets linked to separate keyboards.",
    ...
    },
    {
      ...
      description:
        "The violin is a stringed musical instrument of treble pitch, played with a horsehair bow. The classical European violin was developed in the 16th century. It has four strings and a body of characteristic rounded shape,narrowed at the middle and with two f-shaped soundholes.",
    ...
    {
      img:
        "https://cdn.pixabay.com/photo/2019/02/19/09/02/flute-4006386_1280.jpg",
      name: "Concert Flute",
      type: "Woodwind",
      what: "What is a flute?",
      description:
    ...
    {
      img:
        "https://cdn.pixabay.com/photo/2015/04/15/16/45/mask-724112_1280.jpg",
    ...
    {
      img:
        "https://cdn.pixabay.com/photo/2016/01/23/06/45/cymbal-1157090_1280.jpg",
    ...
    {
      img:
        "https://cdn.pixabay.com/photo/2016/08/14/23/48/percussion-1594338_1280.jpg",
    ...
    {
      img:
        "https://cdn.pixabay.com/photo/2016/08/14/23/47/percussion-1594331_960_720.jpg",
