      ...
      <div className="container_width_register">
        ...
        <form onSubmit={onSubmit}>
          <div action="form-group">
            <h6 className="change_register_text_colour bold" htmlFor="name">
              Name
            </h6>
            <input
              className="white"
          ...
          <div action="form-group">
            <h6 className="change_register_text_colour" htmlFor="email">
              Email Address
            </h6>
            <input
              className="white"
          ...
          <div action="form-group">
            <h6 className="change_register_text_colour" htmlFor="password2">
              Confirm Password
            </h6>
            <input
              className="white"
